...
# GAUSSIAN NOISE
_C.TRANSFORM.GN_P = 0.5
_C.TRANSFORM.GN_MEAN = 0.0
_C.TRANSFORM.GN_SIGMA = 0.01
# BRIGHTNESS
_C.TRANSFORM.BRIGHTNESS = (1.5, 1.5)
_C.TRANSFORM.BRIGHTNESS_P = 0.0
# CONTRAST
_C.TRANSFORM.CONTRAST = (1.5, 1.5)
_C.TRANSFORM.CONTRAST_P = 0.0
# Wiener
_C.TRANSFORM.WIENER_P = 0.5
_C.TRANSFORM.WIENER_K = (5, 5)
_C.TRANSFORM.WIENER_NOISE = None
# Wavelet
_C.TRANSFORM.WAVELET_P = 0.5
_C.TRANSFORM.WAVELET_TYPE = 'db1'
_C.TRANSFORM.WAVELET_LEVELS = 2
_C.TRANSFORM.WAVELET_METHOD = 'BayesShrink'
_C.TRANSFORM.WAVELET_MODE = 'soft'
# TEST
...
_C.RoHL.TEST_MODE = "test_fixed" # inference mode, choose to use adaptive weights or fixed (simply averaging predictions)
