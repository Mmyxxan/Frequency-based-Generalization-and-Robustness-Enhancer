...
def build_dataset(cfg, is_train, split, is_visualize=False, transform=None):
    ...
    if cfg.DATASET.NAME == "CNNSpot":
        ...
        return NTIRE2026Dataset(img_dir=cfg.DATASET.DATA_DIR, split=split, transform=transform, use_jsd=cfg.RoHL.USE_JSD, shard_dirs=["/kaggle/input/datasets/anhphmminh/ntiretrainingset-shard0"])
    else:
